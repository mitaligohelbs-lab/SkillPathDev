        ...
        >
          ...
          <div className="grid grid-cols-3 gap-3 text-center">
            <div>
              ...
              <p className="text-[10px] text-[#707d8f]  uppercase">Avg Score</p>
            </div>
            <div>
          ...
          {totalAvg <= 6 && (
            <p className="text-sm text-[#707d8f]">
              Your current average score is {totalAvg}. Focus on improving
              accuracy in weaker topics to increase your ranking.
            </p>
          )}
        </div>
      ),
